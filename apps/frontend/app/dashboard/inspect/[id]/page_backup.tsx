...
export default function WebhookInspectPage() {
  ...
  return (
    <div className="flex h-screen w-full bg-black text-white overflow-hidden">
      ...
      <div className="flex flex-1 min-w-0 ml-64 h-full">
          ...
          <div className="p-4 border-b border-gray-800 flex-shrink-0">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-black border border-gray-700 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-600"
              />
            </div>
          </div>
          <div className="flex-1 overflow-y-auto">
              {requests.length > 0 ? (
                requests.map((request, index) => {
                  const statusCode = 200; // Placeholder
                  const StatusIcon =
                    statusCode >= 500
                      ? XCircle
                      : statusCode >= 400
                  ...
                  return (
                    <div
                      key={index}
                      className={`px-4 py-3 border-b border-gray-800 cursor-pointer hover:bg-gray-900/70 transition-colors flex flex-col ${
                ...
                <div className="p-6 border-b border-gray-800 flex-shrink-0">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-900 rounded-md border border-gray-700">
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        handleCopy(webhookUrl, "Webhook URL copied!")
                      }
                    ...
                    <TabsList className="grid w-full grid-cols-5 bg-gray-900 border border-gray-700 p-1.5 rounded-lg h-14">
                      <TabsTrigger
                        ...
                        className="px-6 py-3 text-sm font-medium transition-all duration-200 
                                 ...
                                 data-[state=active]:border data-[state=active]:border-blue-700"
                      >
                        Summary
                      </TabsTrigger>
                      <TabsTrigger
